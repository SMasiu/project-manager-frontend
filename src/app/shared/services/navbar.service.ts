...
export class NavbarService {
  ...
  private pageItems: NavbarItem[] = [
    ...
    new NavbarItem(this.router, { value: 'About', icon: 'book', top: 5, path: '/about', displayIfLogged: 0 }),
    new NavbarItem(this.router, { value: 'Contact', icon: 'mail', top: 6, path: '/contact', displayIfLogged: 0}),
    new NavbarItem(this.router, { value: 'Teams', icon: 'people', top: 3, path: '/teams', displayIfLogged: 1, extendedPath: ['/teams/*'] }),
    new NavbarItem(this.router, { value: 'Friends', icon: 'people_alt', top: 4, path: '/friends', displayIfLogged: 1, extendedPath: ['/friends/*'] })
  ]
